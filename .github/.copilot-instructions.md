...
- `GET /api/v1/dataset/{dataset_id}` - Get specific dataset
- `POST /api/v1/dataset/register` - Register new dataset (with JSON-LD validation)
- `PUT /api/v1/dataset/update` - Update dataset with profile
- `POST /api/v1/dataset/query` - Execute analytical pattern query
